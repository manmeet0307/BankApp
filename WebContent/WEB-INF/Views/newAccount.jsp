...
<form:form action="saveAccount" modelAttribute="account">
  ...
  <table>
     ...
     <tr>
         ...
         <form:errors path="accountType" cssClass="error" /></td>
     </tr>
     ...
     <tr>
         ...
         <form:errors path="psCode" cssClass="error" /></td>
     <tr>
